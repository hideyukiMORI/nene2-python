...
| フィールドトライアル | **FT1〜FT219（219 件）** — stdlib 検証ループ継続中 | 🔄 |
...
### 残課題（オープン Issue 含む）
- [#541](https://github.com/hideyukiMORI/nene2-python/issues/541) PyPI 公開フロー未検証（`uv publish` ワークフロー）
- [#539](https://github.com/hideyukiMORI/nene2-python/issues/539) handler の `response_model` 統一
- [#540](https://github.com/hideyukiMORI/nene2-python/issues/540) FT ループの目的・終着点の明文化
...
- [x] Field Trial 7〜219: stdlib フルカバレッジループ（FT7〜FT219、2026-05-23 時点）
- [ ] Field Trial 継続: FT220〜（220 % 4 = 0 → **クラッカーペンテストあり**、テーマ: logging）
